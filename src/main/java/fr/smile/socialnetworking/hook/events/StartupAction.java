...
package fr.smile.socialnetworking.hook.events;
...
import fr.smile.socialnetworking.util.PortletConstants;
	...
	protected void setupExpando(long companyId) throws Exception {
		...
		try {
			table = ExpandoTableLocalServiceUtil.addTable(
				companyId, User.class.getName(), PortletConstants.SMILE_NAMESPACE);
		}
