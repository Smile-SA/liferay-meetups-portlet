...
/**
 * The utility for the meetups entry local service. This utility wraps {@link fr.smile.socialnetworking.service.impl.MeetupsEntryLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see fr.smile.socialnetworking.service.base.MeetupsEntryLocalServiceBaseImpl
 * @see fr.smile.socialnetworking.service.impl.MeetupsEntryLocalServiceImpl
 * @generated
 */
public class MeetupsEntryLocalServiceUtil {
	...
	*/
	public static fr.smile.socialnetworking.model.MeetupsEntry addMeetupsEntry(
	...
	*/
	public static fr.smile.socialnetworking.model.MeetupsEntry createMeetupsEntry(
		long meetupsEntryId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static fr.smile.socialnetworking.model.MeetupsEntry getMeetupsEntry(
		long meetupsEntryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<fr.smile.socialnetworking.model.MeetupsEntry> getMeetupsEntries(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static fr.smile.socialnetworking.model.MeetupsEntry updateMeetupsEntry(
		fr.smile.socialnetworking.model.MeetupsEntry meetupsEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static fr.smile.socialnetworking.model.MeetupsEntry addMeetupsEntry(
		...
		return getService()
			...
			startDateDay, startDateYear, startDateHour, startDateMinute,
			endDateMonth, endDateDay, endDateYear, endDateHour, endDateMinute,
			totalAttendees, maxAttendees, price, thumbnail, groupId);
	}

	public static void deleteMeetupsEntries(long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteMeetupsEntries(groupId);
	}

	public static java.util.List<fr.smile.socialnetworking.model.MeetupsEntry> getMeetupsEntriesByCompany(
		long companyId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getMeetupsEntriesByCompany(companyId);
	}

	public static java.util.List<fr.smile.socialnetworking.model.MeetupsEntry> getMeetupsEntriesByGroup(
		long groupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getMeetupsEntriesByGroup(groupId);
	}

	public static java.util.List<fr.smile.socialnetworking.model.MeetupsEntry> getMeetupsEntriesByUser(
	...
	public static fr.smile.socialnetworking.model.MeetupsEntry updateMeetupsEntry(
		...
		return getService()
			...
			startDateHour, startDateMinute, endDateMonth, endDateDay,
			endDateYear, endDateHour, endDateMinute, totalAttendees,
			maxAttendees, price, thumbnail, groupId);
	}
