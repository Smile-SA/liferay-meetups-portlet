...
import fr.smile.socialnetworking.NoSuchMeetupsRegistrationException;
import fr.smile.socialnetworking.model.MeetupsRegistration;
import fr.smile.socialnetworking.model.impl.MeetupsRegistrationImpl;
import fr.smile.socialnetworking.model.impl.MeetupsRegistrationModelImpl;
 ...
 * @generated
 */
public class MeetupsRegistrationPersistenceImpl extends BasePersistenceImpl<MeetupsRegistration> implements
    ...
    public static final FinderPath FINDER_PATH_FIND_BY_MEETUPSENTRYID  = new FinderPath(
                                                                               ...
                                                                               "findByMeetupsEntryId", new String[] {
            Long.class.getName(),

            "java.lang.Integer", "java.lang.Integer", "com.liferay.portal.kernel.util.OrderByComparator" });
    public static final FinderPath FINDER_PATH_COUNT_BY_MEETUPSENTRYID = new FinderPath(
                                                                               MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
                                                                               MeetupsRegistrationModelImpl.FINDER_CACHE_ENABLED,
                                                                               Long.class, FINDER_CLASS_NAME_LIST,
                                                                               "countByMeetupsEntryId",
                                                                               new String[] { Long.class.getName() });
    public static final FinderPath FINDER_PATH_FETCH_BY_U_ME           = new FinderPath(
                                                                               MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
                                                                               MeetupsRegistrationModelImpl.FINDER_CACHE_ENABLED,
                                                                               MeetupsRegistrationImpl.class,
                                                                               ...
                                                                               new String[] { Long.class.getName(),
            Long.class.getName()                                              });
    public static final FinderPath FINDER_PATH_COUNT_BY_U_ME           = new FinderPath(
                                                                               MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
                                                                               MeetupsRegistrationModelImpl.FINDER_CACHE_ENABLED,
                                                                               Long.class, FINDER_CLASS_NAME_LIST,
                                                                               "countByU_ME", new String[] {
            Long.class.getName(), Long.class.getName()                        });
    public static final FinderPath FINDER_PATH_FIND_BY_ME_S            = new FinderPath(
                                                                               MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
                                                                               MeetupsRegistrationModelImpl.FINDER_CACHE_ENABLED,
                                                                               MeetupsRegistrationImpl.class,
            ...
            "java.lang.Integer", "java.lang.Integer", "com.liferay.portal.kernel.util.OrderByComparator" });
    public static final FinderPath FINDER_PATH_COUNT_BY_ME_S           = new FinderPath(
                                                                               MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
                                                                               MeetupsRegistrationModelImpl.FINDER_CACHE_ENABLED,
                                                                               Long.class, FINDER_CLASS_NAME_LIST,
                                                                               "countByME_S", new String[] {
    ...
    public void cacheResult(MeetupsRegistration meetupsRegistration) {
        EntityCacheUtil.putResult(MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED, MeetupsRegistrationImpl.class,
                meetupsRegistration.getPrimaryKey(), meetupsRegistration);

        FinderCacheUtil.putResult(
                FINDER_PATH_FETCH_BY_U_ME,
                new Object[] { Long.valueOf(meetupsRegistration.getUserId()),
                        Long.valueOf(meetupsRegistration.getMeetupsEntryId()) }, meetupsRegistration);
    ...
    public void cacheResult(List<MeetupsRegistration> meetupsRegistrations) {
        for (MeetupsRegistration meetupsRegistration : meetupsRegistrations) {
            if (EntityCacheUtil.getResult(MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
                    MeetupsRegistrationImpl.class, meetupsRegistration.getPrimaryKey(), this) == null) {
    ...
    public void clearCache(MeetupsRegistration meetupsRegistration) {
        EntityCacheUtil.removeResult(MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED, MeetupsRegistrationImpl.class,
    ...
    /**
     * Removes the meetups registration with the primary key from the database. Also notifies the appropriate model
     * listeners.
     * 
     ...
     */
    @Override
    public MeetupsRegistration remove(Serializable primaryKey) throws NoSuchModelException, SystemException {
     ...
     * @return the meetups registration that was removed
     * @throws fr.smile.socialnetworking.NoSuchMeetupsRegistrationException if a meetups registration with the primary
     *         key could not be found
     * @throws SystemException if a system exception occurred
     */
    @Override
    public MeetupsRegistration remove(long meetupsRegistrationId) throws NoSuchMeetupsRegistrationException,
            SystemException {
        ...
        try {
            ...
            if (meetupsRegistration == null) {
                if (_log.isWarnEnabled()) {
                    _log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + meetupsRegistrationId);
                }

                throw new NoSuchMeetupsRegistrationException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + meetupsRegistrationId);
            }
     ...
     */
    @Override
    public MeetupsRegistration remove(MeetupsRegistration meetupsRegistration) throws SystemException {
        return super.remove(meetupsRegistration);
    }

    @Override
    protected MeetupsRegistration removeImpl(MeetupsRegistration meetupsRegistration) throws SystemException {
        ...
        FinderCacheUtil.removeResult(
                FINDER_PATH_FETCH_BY_U_ME,
                new Object[] { Long.valueOf(meetupsRegistrationModelImpl.getUserId()),
    ...
    @Override
    public MeetupsRegistration updateImpl(fr.smile.socialnetworking.model.MeetupsRegistration meetupsRegistration,
        ...
        if (!isNew
                && ((meetupsRegistration.getUserId() != meetupsRegistrationModelImpl.getOriginalUserId()) || (meetupsRegistration
                        .getMeetupsEntryId() != meetupsRegistrationModelImpl.getOriginalMeetupsEntryId()))) {
            FinderCacheUtil.removeResult(
                    FINDER_PATH_FETCH_BY_U_ME,
                    new Object[] { Long.valueOf(meetupsRegistrationModelImpl.getOriginalUserId()),
    ...
    protected MeetupsRegistration toUnwrappedModel(MeetupsRegistration meetupsRegistration) {
    ...
    /**
     * Finds the meetups registration with the primary key or throws a {@link com.liferay.portal.NoSuchModelException}
     ...
     */
    @Override
    public MeetupsRegistration findByPrimaryKey(Serializable primaryKey) throws NoSuchModelException, SystemException {
        return findByPrimaryKey(((Long) primaryKey).longValue());
    }

    /**
     * Finds the meetups registration with the primary key or throws a
     * {@link fr.smile.socialnetworking.NoSuchMeetupsRegistrationException} if it could not be found.
     * 
     ...
     */
    @Override
    public MeetupsRegistration findByPrimaryKey(long meetupsRegistrationId) throws NoSuchMeetupsRegistrationException,
            SystemException {
     ...
     * 
     * @param primaryKey the primary key of the meetups registration to find
     * @return the meetups registration, or <code>null</code> if a meetups registration with the primary key could not
     *         be found
     * @throws SystemException if a system exception occurred
     */
    @Override
    public MeetupsRegistration fetchByPrimaryKey(Serializable primaryKey) throws SystemException {
     ...
     */
    @Override
    public MeetupsRegistration fetchByPrimaryKey(long meetupsRegistrationId) throws SystemException {
        MeetupsRegistration meetupsRegistration = (MeetupsRegistration) EntityCacheUtil.getResult(
                MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED, MeetupsRegistrationImpl.class,
                meetupsRegistrationId, this);
                ...
                if (meetupsRegistration != null) {
                    ...
                    if (!hasException) {
                        EntityCacheUtil.putResult(MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
                                MeetupsRegistrationImpl.class, meetupsRegistrationId, _nullMeetupsRegistration);
                    }
     ...
     */
    @Override
    public List<MeetupsRegistration> findByMeetupsEntryId(long meetupsEntryId) throws SystemException {
        return findByMeetupsEntryId(meetupsEntryId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
    }
     ...
     */
    @Override
    public List<MeetupsRegistration> findByMeetupsEntryId(long meetupsEntryId, int start, int end)
    ...
    public List<MeetupsRegistration> findByMeetupsEntryId(long meetupsEntryId, int start, int end,
        ...
        List<MeetupsRegistration> list = (List<MeetupsRegistration>) FinderCacheUtil.getResult(
                FINDER_PATH_FIND_BY_MEETUPSENTRYID, finderArgs, this);
        ...
        if (list == null) {
            ...
            try {
                ...
                if (list == null) {
                    FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_MEETUPSENTRYID, finderArgs);
                }
                else {
                    cacheResult(list);

                    FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_MEETUPSENTRYID, finderArgs, list);
                }
     ...
     * @throws fr.smile.socialnetworking.NoSuchMeetupsRegistrationException if a matching meetups registration could not
     *         be found
     * @throws SystemException if a system exception occurred
     */
    @Override
    public MeetupsRegistration findByMeetupsEntryId_First(long meetupsEntryId, OrderByComparator orderByComparator)
            throws NoSuchMeetupsRegistrationException, SystemException {
        List<MeetupsRegistration> list = findByMeetupsEntryId(meetupsEntryId, 0, 1, orderByComparator);
     ...
     */
    @Override
    public MeetupsRegistration findByMeetupsEntryId_Last(long meetupsEntryId, OrderByComparator orderByComparator)
            throws NoSuchMeetupsRegistrationException, SystemException {
        int count = countByMeetupsEntryId(meetupsEntryId);

        List<MeetupsRegistration> list = findByMeetupsEntryId(meetupsEntryId, count - 1, count, orderByComparator);
    ...
    /**
     * Finds the meetups registrations before and after the current meetups registration in the ordered set where
     * meetupsEntryId = &#63;.
     * 
     * <p>
     * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and
     ...
     */
    @Override
    public MeetupsRegistration[] findByMeetupsEntryId_PrevAndNext(long meetupsRegistrationId, long meetupsEntryId,
            OrderByComparator orderByComparator) throws NoSuchMeetupsRegistrationException, SystemException {
        ...
        try {
            ...
            array[0] = getByMeetupsEntryId_PrevAndNext(session, meetupsRegistration, meetupsEntryId, orderByComparator,
                    true);

            array[1] = meetupsRegistration;

            array[2] = getByMeetupsEntryId_PrevAndNext(session, meetupsRegistration, meetupsEntryId, orderByComparator,
                    false);
    ...
    protected MeetupsRegistration getByMeetupsEntryId_PrevAndNext(Session session,
            MeetupsRegistration meetupsRegistration, long meetupsEntryId, OrderByComparator orderByComparator,
            boolean previous) {
        StringBundler query = null;
    ...
    /**
     * Finds the meetups registration where userId = &#63; and meetupsEntryId = &#63; or throws a
     * {@link fr.smile.socialnetworking.NoSuchMeetupsRegistrationException} if it could not be found.
     * 
     ...
     */
    @Override
    public MeetupsRegistration findByU_ME(long userId, long meetupsEntryId) throws NoSuchMeetupsRegistrationException,
            SystemException {
    ...
    /**
     * Finds the meetups registration where userId = &#63; and meetupsEntryId = &#63; or returns <code>null</code> if it
     * could not be found. Uses the finder cache.
     * 
     * @param userId the user ID to search with
     * @param meetupsEntryId the meetups entry ID to search with
     * @return the matching meetups registration, or <code>null</code> if a matching meetups registration could not be
     *         found
     * @throws SystemException if a system exception occurred
     */
    @Override
    public MeetupsRegistration fetchByU_ME(long userId, long meetupsEntryId) throws SystemException {
     ...
     */
    @Override
    public MeetupsRegistration fetchByU_ME(long userId, long meetupsEntryId, boolean retrieveFromCache)
            throws SystemException {
        ...
        if (result == null) {
            ...
            try {
                ...
                if (result == null) {
                    FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_U_ME, finderArgs);
                }
     ...
     */
    @Override
    public List<MeetupsRegistration> findByME_S(long meetupsEntryId, int status) throws SystemException {
        return findByME_S(meetupsEntryId, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
    }
     ...
     */
    @Override
    public List<MeetupsRegistration> findByME_S(long meetupsEntryId, int status, int start, int end)
            throws SystemException {
    ...
    public List<MeetupsRegistration> findByME_S(long meetupsEntryId, int status, int start, int end,
        ...
        List<MeetupsRegistration> list = (List<MeetupsRegistration>) FinderCacheUtil.getResult(
                FINDER_PATH_FIND_BY_ME_S, finderArgs, this);
        ...
        if (list == null) {
            ...
            try {
                ...
                if (list == null) {
                    FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_ME_S, finderArgs);
                }
                else {
                    cacheResult(list);

                    FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_ME_S, finderArgs, list);
                }
     ...
     */
    @Override
    public MeetupsRegistration findByME_S_First(long meetupsEntryId, int status, OrderByComparator orderByComparator)
            throws NoSuchMeetupsRegistrationException, SystemException {
        List<MeetupsRegistration> list = findByME_S(meetupsEntryId, status, 0, 1, orderByComparator);
     ...
     */
    @Override
    public MeetupsRegistration findByME_S_Last(long meetupsEntryId, int status, OrderByComparator orderByComparator)
            throws NoSuchMeetupsRegistrationException, SystemException {
     ...
     */
    @Override
    public MeetupsRegistration[] findByME_S_PrevAndNext(long meetupsRegistrationId, long meetupsEntryId, int status,
            OrderByComparator orderByComparator) throws NoSuchMeetupsRegistrationException, SystemException {
        MeetupsRegistration meetupsRegistration = findByPrimaryKey(meetupsRegistrationId);
        ...
        try {
            ...
            array[0] = getByME_S_PrevAndNext(session, meetupsRegistration, meetupsEntryId, status, orderByComparator,
                    true);

            array[1] = meetupsRegistration;

            array[2] = getByME_S_PrevAndNext(session, meetupsRegistration, meetupsEntryId, status, orderByComparator,
                    false);
    ...
    protected MeetupsRegistration getByME_S_PrevAndNext(Session session, MeetupsRegistration meetupsRegistration,
            long meetupsEntryId, int status, OrderByComparator orderByComparator, boolean previous) {
        StringBundler query = null;
     ...
     */
    @Override
    public List<MeetupsRegistration> findAll(int start, int end) throws SystemException {
     ...
     */
    @Override
    public List<MeetupsRegistration> findAll(int start, int end, OrderByComparator orderByComparator)
            throws SystemException {
     ...
     */
    @Override
    public void removeByMeetupsEntryId(long meetupsEntryId) throws SystemException {
        for (MeetupsRegistration meetupsRegistration : findByMeetupsEntryId(meetupsEntryId)) {
     ...
     */
    @Override
    public void removeByU_ME(long userId, long meetupsEntryId) throws NoSuchMeetupsRegistrationException,
            SystemException {
        MeetupsRegistration meetupsRegistration = findByU_ME(userId, meetupsEntryId);
     ...
     */
    @Override
    public void removeByME_S(long meetupsEntryId, int status) throws SystemException {
        for (MeetupsRegistration meetupsRegistration : findByME_S(meetupsEntryId, status)) {
            meetupsRegistrationPersistence.remove(meetupsRegistration);
        }
    }
     ...
     */
    @Override
    public int countByMeetupsEntryId(long meetupsEntryId) throws SystemException {
        Object[] finderArgs = new Object[] { meetupsEntryId };

        Long count = (Long) FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_MEETUPSENTRYID, finderArgs, this);
        ...
        if (count == null) {
            ...
            try {
                ...
                FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_MEETUPSENTRYID, finderArgs, count);
     ...
     */
    @Override
    public int countByU_ME(long userId, long meetupsEntryId) throws SystemException {
        Object[] finderArgs = new Object[] { userId, meetupsEntryId };
     ...
     */
    @Override
    public int countByME_S(long meetupsEntryId, int status) throws SystemException {
        Object[] finderArgs = new Object[] { meetupsEntryId, status };

        Long count = (Long) FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_ME_S, finderArgs, this);
        ...
        if (count == null) {
            ...
            try {
                ...
                FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_ME_S, finderArgs, count);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(com.liferay.util.service.ServiceProps
                .get("value.object.listener.fr.smile.socialnetworking.model.MeetupsRegistration")));
        ...
        if (listenerClassNames.length > 0) {
            try {
                ...
                for (String listenerClassName : listenerClassNames) {
                    listenersList.add((ModelListener<MeetupsRegistration>) InstanceFactory
    ...
    private static Log                             _log                                           = LogFactoryUtil
                                                                                                          .getLog(MeetupsRegistrationPersistenceImpl.class);
    ...
    private static CacheModel<MeetupsRegistration> _nullMeetupsRegistrationCacheModel             = new CacheModel<MeetupsRegistration>() {
