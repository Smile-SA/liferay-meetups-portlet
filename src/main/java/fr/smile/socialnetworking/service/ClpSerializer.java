...
import fr.smile.socialnetworking.model.MeetupsEntryClp;
import fr.smile.socialnetworking.model.MeetupsRegistrationClp;
...
public class ClpSerializer {
	...
	public static Object translateInputMeetupsEntry(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("fr.smile.socialnetworking.model.impl.MeetupsEntryImpl",
						true, _classLoader);
				...
				Method method9 = newModelClass.getMethod("setStartDate",
						new Class[] { Date.class });

				Date value9 = oldCplModel.getStartDate();

				method9.invoke(newModel, value9);

				Method method10 = newModelClass.getMethod("setEndDate",
						new Class[] { Date.class });

				Date value10 = oldCplModel.getEndDate();

				method10.invoke(newModel, value10);

				Method method11 = newModelClass.getMethod("setTotalAttendees",
						new Class[] { Integer.TYPE });

				Integer value11 = new Integer(oldCplModel.getTotalAttendees());

				method11.invoke(newModel, value11);

				Method method12 = newModelClass.getMethod("setMaxAttendees",
						new Class[] { Integer.TYPE });

				Integer value12 = new Integer(oldCplModel.getMaxAttendees());

				method12.invoke(newModel, value12);

				Method method13 = newModelClass.getMethod("setPrice",
						new Class[] { Double.TYPE });

				Double value13 = new Double(oldCplModel.getPrice());

				method13.invoke(newModel, value13);

				Method method14 = newModelClass.getMethod("setThumbnailId",
						new Class[] { Long.TYPE });

				Long value14 = new Long(oldCplModel.getThumbnailId());
	...
	public static Object translateInputMeetupsRegistration(
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("fr.smile.socialnetworking.model.impl.MeetupsRegistrationImpl",
						true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"fr.smile.socialnetworking.model.impl.MeetupsEntryImpl")) {
			return translateOutputMeetupsEntry(oldModel);
		}

		if (oldModelClassName.equals(
					"fr.smile.socialnetworking.model.impl.MeetupsRegistrationImpl")) {
	...
	public static Object translateOutputMeetupsEntry(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				...
				Method method9 = oldModelClass.getMethod("getStartDate");

				Date value9 = (Date)method9.invoke(oldModel, (Object[])null);

				newModel.setStartDate(value9);

				Method method10 = oldModelClass.getMethod("getEndDate");

				Date value10 = (Date)method10.invoke(oldModel, (Object[])null);

				newModel.setEndDate(value10);

				Method method11 = oldModelClass.getMethod("getTotalAttendees");

				Integer value11 = (Integer)method11.invoke(oldModel,
						(Object[])null);

				newModel.setTotalAttendees(value11);

				Method method12 = oldModelClass.getMethod("getMaxAttendees");

				Integer value12 = (Integer)method12.invoke(oldModel,
						(Object[])null);

				newModel.setMaxAttendees(value12);

				Method method13 = oldModelClass.getMethod("getPrice");

				Double value13 = (Double)method13.invoke(oldModel,
						(Object[])null);

				newModel.setPrice(value13);

				Method method14 = oldModelClass.getMethod("getThumbnailId");

				Long value14 = (Long)method14.invoke(oldModel, (Object[])null);

				newModel.setThumbnailId(value14);
